...
readonly JETPACK_VERSION=r32.3.1
...
docker build \
    ...
    -f "tegra-ubuntu.Dockerfile" -t mdegans/l4t-base:$JETPACK_VERSION-t210 .
docker tag mdegans/l4t-base:$JETPACK_VERSION-t210 mdegans/l4t-base:$JETPACK_VERSION
